...
import 'package:poke_api/app/modules/home/home_rx_controller.dart';
...
void main() {
  ...
  HomeRxController home;

  setUp(() {
    home = HomeModule.to.get<HomeRxController>();
  });

  group('HomeController Test', () {
    test("First Test", () {
      expect(home, isInstanceOf<HomeRxController>());
    });
